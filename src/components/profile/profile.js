                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                <input type="text" name="" placeholder="Email" tabIndex="10" required />
                                                                </div>
                                                            </div>
                                                            <hr />
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                <input type="text" name="" placeholder="Phone No"  tabIndex="10" required />
                                                                </div>
                                                            </div>
                                                            <hr />
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                <input type="text" name="" placeholder="Mobile No." tabIndex="10" required />
                                                                </div>
                                                            </div>
                                                            <hr />
                                                            <div class="row">
